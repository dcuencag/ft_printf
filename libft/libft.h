...
/*   Updated: 2025/02/06 18:36:48 by dancuenc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @return A pointer to the first occurrence of the character in the block of memory, or NULL if not found
 */
 ...
 * @return A pointer to the first occurrence of the substring in the string, or NULL if not found
 */
...
/**
 * Create a new linked list by applying a function to each element of a linked list
 * @param lst The linked list
 * @param f The function to apply
 * @param del The function to delete the content of each element
